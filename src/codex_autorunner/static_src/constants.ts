export const CONSTANTS = {
  ...
  PROMPTS: {
    ...
    CAR_CONTEXT_HINT:
      "Context: This repo is managed by Codex Autorunner (CAR). Read `.codex-autorunner/ABOUT_CAR.md` (tickets, workspace docs, helper commands) before making workflow assumptions.",
  },
  KEYWORDS: {
    CAR_CONTEXT: [
      "car",
